namespace Vecc.Netduino.Drivers.Ili9341.NetduinoHelperFonts
{
    public static class DejaVuSansCondensed9
    {
        public static readonly byte FontSpace = 2;
        public static readonly byte Height = 13;
